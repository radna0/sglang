...
class Envs:
    ...
    # Experimental: enable FourOverSix-inspired adaptive block scaling for FP4 KV cache
    # (only takes effect when `--kv-cache-dtype fp4_e2m1` is used).
    SGLANG_EXPERIMENTAL_NVFP4 = EnvBool(False)
