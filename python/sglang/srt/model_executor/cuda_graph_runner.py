...
class CudaGraphRunner:
    ...
    def __init__(self, model_runner: ModelRunner):
        ...
        if (
            ...
            if self.model_runner.is_draft_worker and not model_runner.spec_algorithm.is_dflash():
    ...
    def get_spec_info(self, num_tokens: int):
        ...
        if (
            ...
            # Avoid forcing custom-mask mode during graph capture for backends that
