...
ROOT_DIR="${1:-/workspace/route5_per_question_sampled_block4to8_20260329}"
mkdir -p "${ROOT_DIR}"
export ROOT_DIR
...
PORT_EXPLORE_BASE="${PORT_EXPLORE_BASE:-23410}"
PORT_CONTINUE_BASE="${PORT_CONTINUE_BASE:-23460}"
