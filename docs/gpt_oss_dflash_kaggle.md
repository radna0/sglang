# Kaggle: GPT-OSS-120B + DFlash (FA3 / experimental FA4) on H100
...
- Gold-stable GPT-OSS + DFlash serving remains `fa3` today.
- Experimental Hopper FA4 support now exists in this fork when `SGLANG_FA4_PREFER_HOPPER_FLASH_ATTN=1`.
- DFlash draft workers now accept both `fa3` and `fa4`.
